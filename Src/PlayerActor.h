...
#ifndef PLAYERACTOR_H_INCLUDE
#define PLAYERACTOR_H_INCLUDE
#include "GLFWEW.h"
...
public:
	PlayerActor(const Terrain::HeightMap* hm, const Mesh::Buffer& buffer,
		const glm::vec3& pos, const glm::vec3& rot = glm::vec3(0));	virtual ~PlayerActor() = default;
